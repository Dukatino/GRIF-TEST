            ...
            if (this.betOn.win) {
              if (match.home) {
                if (!match["1-bool"]) {
                  ...
                  this.bank += this.bet * adjustedOdd1;
                ...
                if (!match["2-bool"]) {
                  ...
                  this.bank += this.bet * adjustedOdd2;
              ...
              if (!match["x-bool"]) {
                ...
                this.bank += this.bet * adjustedOddX;
              ...
              [match["1"], match["x"], match["2"]].forEach((odd, index) => {
              ...
              if (
                ![match["1"], match["x"], match["2"]].some((odd) =>
